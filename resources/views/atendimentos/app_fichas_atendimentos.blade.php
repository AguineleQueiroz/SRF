        ...
        <table class="min-w-full bg-white border">
            <thead>
                <tr>
                    ...
                    <th class="py-2 px-4 border-b">Tipo de Atenção</th>
            ...
            <tbody>
                ...
                <tr>
                    <td class="py-2 px-4 border-b">{{ \Carbon\Carbon::parse($ficha->created_at)->format('d/m/Y') }}</td>
                    <td class="py-2 px-4 border-b">{{ $ficha->tipo_ficha }}</td>
                    <td class="py-2 px-4 border-b">
                        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded" data-toggle="modal" data-target="#viewFichaModal{{ $ficha->id }}" style="background-color: #186f65;">
                            Visualizar
                        </button>
