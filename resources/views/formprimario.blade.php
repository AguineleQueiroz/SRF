...
<div class="mb-4">
    ...
    <div class="grid grid-cols-1 gap-4">
        ...
        <input type="checkbox" class="form-checkbox h-5 w-5 text-blue-500 shadow-md" name="motivos[]" value="dor" onchange="toggleField(this)" 
        data-target="dor" onfocus="this.blur()" id="dor">
        ...
        <label for="motivos" class="flex items-center">
        <input type="checkbox" class="form-checkbox h-5 w-5 text-blue-500 shadow-md " name="motivos[]" value="incapacidade" onchange="toggleField(this)" 
        data-target="avds" onfocus="this.blur()"  id="incapacidade">
