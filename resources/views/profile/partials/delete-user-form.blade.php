<section class="space-y-6">
    ...
    <x-danger-button style="background-color: #ef4444; box-shadow: 0px 6px 6px -3px rgba(0,0,0,0.5);"
        x-data=""
    ...
    <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6">
            ...
            <div class="mt-6 flex justify-end">
                ...
                <x-danger-button class="ms-3" style="background-color: #ef4444; box-shadow: 0px 6px 6px -3px rgba(0,0,0,0.5);">
                    {{ __('Deletar Conta') }}
                </x-danger-button>
            </div>
        </form>
